    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=10, verbose_name='Укажите имя игрока')),
                ...
                ('sport', models.CharField(choices=[('Каратэ', 'Каратэ'), ('Кунг-фу', 'Кунг-фу'), ('Муай-тай', 'Муай-тай'), ('Бокс', 'Бокс'), ('Кикбокс', 'Кикбокс'), ('Рестлинг', 'Рестлинг'), ('Нинзитсу', 'Нинзитсу')], max_length=100, verbose_name='Выберите спорт персонажа')),
